      ...
      <div className="mx-auto flex items-center justify-between px-4 md:px-31 w-full h-full">
        <div className="flex items-center gap-8 md:gap-12">
          ...
          <nav className="hidden md:flex gap-8">
            <Link href="/job-listings" className="transition text-[#515B6F] font-[Epilogue] text-[16px] font-medium leading-[160%] hover:text-[#4640DE]" style={{ fontFamily: 'Epilogue, sans-serif', fontWeight: 500 }}>Find Jobs</Link>
            <Link href="/companies" className="transition text-[#515B6F] font-[Epilogue] text-[16px] font-medium leading-[160%] hover:text-[#4640DE]" style={{ fontFamily: 'Epilogue, sans-serif', fontWeight: 500 }}>Browse Companies</Link>
          </nav>
        </div>
        <button
          ...
          >
            ...
            >
              ...
              <nav className="flex flex-col gap-6 mt-8">
                <Link href="/job-listings" className="text-[#515B6F] font-[Epilogue] text-[18px] font-medium leading-[160%] hover:text-[#4640DE]" style={{ fontFamily: 'Epilogue, sans-serif', fontWeight: 500 }}>Find Jobs</Link>
                <Link href="/companies" className="text-[#515B6F] font-[Epilogue] text-[18px] font-medium leading-[160%] hover:text-[#4640DE]" style={{ fontFamily: 'Epilogue, sans-serif', fontWeight: 500 }}>Browse Companies</Link>
              </nav>
